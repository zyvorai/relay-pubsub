...
Publish JSON payloads into a selected topic.

## When to use it

- Open **Incoming** when the job matches this screen
- Prefer the product home / Get started panel if you are unsure where to begin
- Confirm health and auth tokens if probes fail

## How to get there

- UI path: `/ui/` → **Incoming** (or matching nav tab)
...
2. Navigate to **Incoming**.
3. Complete the on-screen fields / actions for this surface (Publish JSON payloads into a selected topic.).
