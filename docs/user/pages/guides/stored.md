...
Peek topic message counts and payloads without consuming. Empty state can reopen the setup guide.

## When to use it

- Open **Stored** when the job matches this screen
- Prefer the product home / Get started panel if you are unsure where to begin
- Confirm health and auth tokens if probes fail

## How to get there

- UI path: `/ui/` → **Stored** (or matching nav tab)
...
2. Navigate to **Stored**.
3. Complete the on-screen fields / actions for this surface (Peek topic message counts and payloads without consuming. Empty state can reopen the setup guide.).
