...
Run healthz, smoke, and conformance from the browser.

## When to use it

- Open **Tests** when the job matches this screen
- Prefer the product home / Get started panel if you are unsure where to begin
- Confirm health and auth tokens if probes fail

## How to get there

- UI path: `/ui/` → **Tests** (or matching nav tab)
...
2. Navigate to **Tests**.
3. Complete the on-screen fields / actions for this surface (Run healthz, smoke, and conformance from the browser.).
